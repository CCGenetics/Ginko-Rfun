...
### Plot Proportion of populations mantained (indicator 2) by method
```{r}
# Prepare data for plot with nice labels:
# sample size of TOTAL populations
sample_size <- indicators_full %>%
